<dashboard>
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        <br>
        <div id="mainb" style="height: 350px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; position: relative; background-color: transparent;" _echarts_instance_="ec_1474059487884"><div style="position: relative; overflow: hidden; width: 598px; height: 350px;"><canvas width="598" height="350" data-zr-dom-id="zr_0" style="position: absolute; left: 0px; top: 0px; width: 598px; height: 350px; -webkit-user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas></div><div></div></div>
        <div>
            <h4>Recent Activity</h4>
            <!-- end of user messages -->
            <ul class="messages">
                <li>
                    <img src="/bower_components/gentelella/production/images/img.jpg" class="avatar" alt="Avatar">
