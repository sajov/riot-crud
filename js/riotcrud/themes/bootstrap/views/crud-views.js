riot.tag2('crud-action-menu', '<div class="btn-group"> <a if="{opts.actions.edit}" class="btn btn-primary btn-sm" href="#{opts.name}/edit/{opts.data.id}" onclick="{edit}">Edit</a> <a if="{opts.actions.view}" class="btn btn-info btn-sm" href="#{opts.name}/view/{opts.data.id}" onclick="{view}">View</a> <a if="{opts.actions.save}" class="btn btn-success btn-sm" href="#" onclick="{save}">Save</a> <a if="{opts.actions.delete}" class="btn btn-danger btn-sm" href="#" onclick="{parent.delete}">Delete</a> <a if="{opts.actions.create}" class="btn btn-warning btn-sm" href="#{opts.name}/create/">New</a> <a if="{opts.actions.list}" class="btn btn-default btn-sm" href="#{opts.name}/list" onclick="{list}">List</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </div>', '', '', function(opts) {
