                        ...
                        case 'unmount':
                            ...
                            for (var i = 0; i < events.length; i++) {
                                if (event == 'unmount') {
                                    ...
                                    RiotControl.on(_this2.events[events[i]], self[events[i]]);
                                }
                            }
                            break;
                        default:
    ...
    var viewActionsMixin = {
        init: function init() {
            ...
            this.on('*', function (event) {
                ...
                if (event != 'before-mount' || event != 'update') var view = _this3.opts.view || 'undefined';

                _this3.opts.actions = actions.map(function (action, index) {

                    action.active = false;
                    if (['delete', 'print', 'pdf', 'csv', 'json'].indexOf(action.name) != -1) {
                        action.count = _this3.opts.selection || 0;
                    }
                    ...
                    if (_this3.opts.buttons && _this3.opts.buttons[action.name]) {
                        action.active = true;
                    }
